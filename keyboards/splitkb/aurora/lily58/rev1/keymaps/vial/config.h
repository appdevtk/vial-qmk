...
#define LCPO_KEYS KC_LCTL, KC_ALGR, KC_7
#define RCPC_KEYS KC_RCTL, KC_ALGR, KC_0
#define LAPO_KEYS KC_LALT, KC_ALGR, KC_8
#define RAPC_KEYS KC_RALT, KC_ALGR, KC_9
...
//#define RGB_MATRIX_MAXIMUM_BRIGHTNESS 150 now in keyboard.json
